...
parserConfig : Types.ParserConfig TwoColumnsOfInts Int
parserConfig =
    { inputParser = Parser.parseTwoColumnsOfInts
    , converter = combineLists
    , render = Render.intWithMessage "The sum of the distances between the sorted columns"
    }
